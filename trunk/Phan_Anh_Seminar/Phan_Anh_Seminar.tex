...
other nodes from the graph in the set without it ceasing to be a clique. Figure shows an example of cliques.

\begin{figure}[htbp]
    \centering
    \subfigure[]
    {
    	\includegraphics[width=0.25\textwidth]{images/clique.png}
        \label{fig:clique}
    }
    \subfigure[]
    {
    	\includegraphics[width=0.35\textwidth]{images/shape_energy.png}
        \label{fig:shape_energy}
    }
    \caption{(a) Image source: \cite{bishop2006pattern}. (b)Image source: \cite{shimizu2011automated}.}
\end{figure}
