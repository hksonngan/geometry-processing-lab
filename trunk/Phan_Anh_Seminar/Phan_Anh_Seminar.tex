...
\begin{abstract}%
This seminar paper reviews several different graph-based approaches to the image segmentation problem and demonstrates some applications of these techniques to real-world problems. It also discusses pros and cons and gives some comparisons between these graph-cut methods.
\end{abstract}
