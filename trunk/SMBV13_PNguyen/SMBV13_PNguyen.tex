...
\begin{figure}[htbp]
    ...
    \caption{Region graph pipeline. (a) We oversegment the test image and construct a region-graph. (b) A region's node weight is its contribution to the classifier response. The optimal contiguous set of regions is equivalent to the maximum-weight connected subgraph problem (MWCS) on the vertex weighted region-graph. (c) We incorporate class-specific inter-region contour cues by adding edge costs leading to the PCST problem. (d) The best scoring region is obtained by efficiently solving the PCST instance with a branch-and-cut algorithm. Image source \cite{VijayGrauman2011}.}
...
\STATE \qquad $H(\delta) \leftarrow \dfrac{\Pi P e^{-i\delta} + P^T \Pi e^{i\delta}}{2}$
\STATE \qquad Solve $\Pi^{-1} H(\delta)x = \lambda x$ for top $k$ eigenvectors.
\ENDFOR
\end{algorithmic}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.3\textwidth]{Bilder/SMBV13_EMuster_fig21}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{Bilder/SMBV13_EMuster_fig22}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{Bilder/SMBV13_EMuster_fig23}
...
\begin{figure}[htbp]
    ...
    \subfigure[]
    {
    	\includegraphics[width=0.30\textwidth]{Bilder/SMBV13_EMuster_fig24}
        \label{fig:contour_cut_pr}
    }
    \subfigure[]
    {
    	\includegraphics[width=0.65\textwidth]{Bilder/SMBV13_EMuster_fig25}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.35\textwidth]{Bilder/SMBV13_EMuster_fig26}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{Bilder/SMBV13_EMuster_fig27}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{Bilder/SMBV13_EMuster_fig28}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{Bilder/SMBV13_EMuster_fig29}
