...
\renewcommand*{\occasion}{Seminar Medical Image Processing -- MedBV 13}		% (used for \TitlePage)
...
\begin{table}
  ...
  \begin{tabular}{@{} M{.25\linewidth} M{.25\linewidth} M{.25\linewidth} M{.25\linewidth} @{}}
      \includegraphics[width=0.2\textwidth]{shape_desc1}%
      &
      \includegraphics[width=0.2\textwidth]{shape_desc2}%
      &
      \includegraphics[width=0.2\textwidth]{shape_desc3}%
      &
      \includegraphics[width=0.2\textwidth]{shape_desc4}%
  \end{tabular}
\end{table}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\headline{Graph Cut Algorithms}
\vfill
\begin{itemize}
\item Region Graph
\begin{itemize}
