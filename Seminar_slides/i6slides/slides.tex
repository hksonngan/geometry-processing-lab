...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Mobile robots: object recognition.
	\end{itemize}
	...
	\begin{itemize}
		...
		\item Can express different kinds of problems
		\item Leads to well-known graph problems\\
		$\Rightarrow$ can be solved efficiently
	\end{itemize}
\end{itemize}
%\begin{figure}
%	\centering
...
\item Represented as high dimensional vectors
\item Point features: Speeded Up Robust Features
\item Shape features: Probability of Boundary
\end{itemize}
\vfill
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\headline{Image Features: Gradient-based Detectors}
\small
\vfill
\begin{enumerate}
...
\begin{figure}
	\centering
	\includegraphics[width=0.3\textwidth]{bag_of_features}
