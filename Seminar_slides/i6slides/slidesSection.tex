...
%%
%% $Id: slidesSection.tex,v 1.22 2007-11-15 07:58:53 dreuw Exp $
%%
...
%%  - page layout    : 'vertical' to enable vertical centering on each slide using \vfill ... \vfill
%%  - encoding       : 'utf-8' to enable utf encoding instead of latin1 (default)
%%
\documentclass[11pt,a4paper,landscape]{article}
\usepackage[english, userlastpage, triangle, utf-8]{NeyDreuwSlides_Nov07}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{Page Titles} \renewcommand*{\topleftlogo}{} %% remove the third logo defined at the previous slide
