...
Graph-based segmentation is currently emerging as a promising method and has been applied successfully to many image processing applications ranging from real-world image understanding and segmentation to medical image analysis. Formulating segmentation problems by means of graph-cut problems has a twofold advantage: firstly, graph representation is an abstract way to encode generic, complex relationships between entities, thereby opening up to a wide variety of approaches and interpretations for the segmentation problems; secondly, graph representation often leads to well-known graph problems which can be solved exactly under some conditions.
...
This seminar paper presents several different graph-based approaches to the image segmentation problem and demonstrates some applications of these techniques to real-world problems. It also discusses pros and cons and gives some comparisons between these graph-cut methods.
