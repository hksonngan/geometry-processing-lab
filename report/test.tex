...
\begin{figure}[htbp]
    ...
    \subfigure[]
    {
        \includegraphics[width=0.45\textwidth]{umbrella.pdf}
        \label{fig:umbrella::a}
    }
    \subfigure[]
    {
        \includegraphics[width=0.45\textwidth]{cotangent.pdf}
        \label{fig:umbrella::b}
    }
...
\begin{figure}[htbp]
    ...
    \subfigure[]
    {
        \includegraphics[width=0.45\textwidth]{edge_normal.pdf}
        \label{fig:curvature::a}
    }
    \subfigure[]
    {
        \includegraphics[width=0.45\textwidth]{dihedral.pdf}
        \label{fig:curvature::b}
    }
...
\centering
    \subfigure[]
    {
        \includegraphics[width=0.6\textwidth]{volume.pdf}
        \label{fig:volume::a}
    }
    \subfigure[]
    {
        \includegraphics[width=0.35\textwidth]{angles.pdf}
        \label{fig:volume::b}
    }
...
%Possibly the problem has to do with xxx ...  details found in the Appendix A
%Appendix $\ref{apx:implicit}$ will discuss some attempts to deal with the implicit integration method which is also open for future work.
